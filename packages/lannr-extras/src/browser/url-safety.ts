...
interface UrlSafetyErrorOptions {
  code?: string
  hostname?: string
}
...
export class UrlSafetyError extends Error {
  ...
  constructor(message: string, { code, hostname }: UrlSafetyErrorOptions = {}) {
    super(message)
...
export async function assertSafeUrl(value, { allowPrivate }: { allowPrivate?: boolean } = {}) {
